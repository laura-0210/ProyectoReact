  ...
  return (
    <div className="gameboy-screen">
      ...
      <div className="alert-area">
        {hunger > 80 && (
          <div className="alert alert-danger pixel-alert">¡TENGO HAMBRE! 🍖</div>
        )}
        {happiness < 20 && (
      ...
      <div className="stats-container">
        ...
        <div className="stat-row">
          ...
          <div className="progress" style={{ height: '20px', border: '2px solid #0f380f', borderRadius: 0 }}>
            <div 
        ...
        <div className="stat-row">
          ...
          <div className="progress" style={{ height: '20px', border: '2px solid #0f380f', borderRadius: 0 }}>
            <div 
              ...
              style={{ width: `${happiness}%`, color: 'black', transition: 'width 0.5s' }}
            >
              {happiness}%
            </div>
          </div>
